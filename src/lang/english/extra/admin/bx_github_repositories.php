...
define('BX_GITHUB_REPOSITORIES_LABEL_SELECT_ALL_REPOSITORIES', 'Select or deselect all repositories');
...
define('BX_GITHUB_REPOSITORIES_ERROR_NO_TEMPLATE_PRODUCT', 'No template product configured. Please set the template product ID in the module settings.');
define('BX_GITHUB_REPOSITORIES_ERROR_TEMPLATE_NOT_FOUND', 'Template product with ID %d was not found.');
define('BX_GITHUB_REPOSITORIES_INFO_PRODUCT_CREATED', 'Product for %s created (ID %d).');
define('BX_GITHUB_REPOSITORIES_INFO_PRODUCT_UPDATED', 'Product for %s updated (ID %d).');
define('BX_GITHUB_REPOSITORIES_SUCCESS_PRODUCT_DELETED', 'Product for %s deleted (ID %d).');
define('BX_GITHUB_REPOSITORIES_INFO_NO_PRODUCT_TO_DELETE', 'No mapped product exists for %s.');
define('BX_GITHUB_REPOSITORIES_WARNING_PRODUCT_SYNC_FAILED', 'Product sync for %s failed: %s');
define('BX_GITHUB_REPOSITORIES_WARNING_PRODUCT_DELETE_FAILED', 'Product deletion for %s failed: %s');
define('BX_GITHUB_REPOSITORIES_TEXT_CONFIRM_DELETE_PRODUCT', 'Delete product permanently? This action cannot be undone.');
