...
define('BX_GITHUB_REPOSITORIES_LABEL_PRODUCT', 'Produkt');
define('BX_GITHUB_REPOSITORIES_LABEL_LAST_CHECK', 'Letzter Check');
define('BX_GITHUB_REPOSITORIES_TEXT_OPEN_DOWNLOAD_FILE', 'Datei im Download-Ordner öffnen');
define('BX_GITHUB_REPOSITORIES_TEXT_DOWNLOAD_FILE_MISSING', 'Datei nicht im Download-Ordner gefunden');
define('BX_GITHUB_REPOSITORIES_TEXT_ZIP_PRESENT', 'ZIP vorhanden');
define('BX_GITHUB_REPOSITORIES_TEXT_FILE_MISSING', 'Datei fehlt');
